from titletrigger.textsum.textsum.toolbox.utils import padding_list
from titletrigger.textsum.textsum.toolbox.vocab import Vocabulary, BOS_WORD, EOS_WORD, UNK_WORD
from titletrigger.extraction.extractive_keywords import extract_keywords
...
def keywords_extract(text, K=5):
    extract_keywords(text, K)


def tag_classify(text_list, model_file):
...
def abs_summarize(text_list, model_file):
    """
